"""
Django settings for twiads project.
...
from twiads.logger_formatter import ContextFormatter
...
WSGI_APPLICATION = "twiads.wsgi.application"
...
MEDIA_ROOT = os.path.join(BASE_DIR.parents[3], "media", "twiads")
print(MEDIA_ROOT)
MEDIA_URL = "/media/"
